# app.py
# V5.9 - Restored display logic to fix IndentationError.
...
def reset_search():
    ...
    # Keep sidebar controls by selectively clearing keys
...
if 'results' in st.session_state and st.session_state.results:
    ...
    if results_to_display:
        ...
        with st.spinner("Getting detailed explanations from reasoning LLM..."):
            ...
            current_entity_type = results_to_display[0]['full_record']['type'] if results_to_display[0].get('full_record') else 'individual'
            ...
            for result in results_to_display:
                ...
                with st.container(border=True):
                    ...
                    with st.expander("Show Full Analysis Dossier"):
                        ...
                        if screening_data.get('input_analysis'): # Check if it's an individual result
